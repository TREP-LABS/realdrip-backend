...
<body>
  <div class="container">
    <div class="content">
      ...
      <div class="info">
        <p>Hi <span class="user-name">${name}</span>, a nurse account has been created for you on the Realdrip platform by your ward administrator.<br /> These are your login credentials:
          <br />
